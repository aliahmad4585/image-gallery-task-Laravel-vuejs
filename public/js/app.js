...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    fav: function fav(imageId, userId) {
      var _this = this;
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 4:
                _context.next = 6;
                return axios__WEBPACK_IMPORTED_MODULE_0___default().post("fav", {
                  userId: _this.userId,
                  imageId: imageId
                    ...
                    "span",
                    {
                      on: {
                        click: function ($event) {
                          return _vm.fav(result.id, result.user_id)
                        },
                      },
                    },
                    [
                      _c(
                        "i",
                        {
                          staticClass: "material-icons amaranth",
                          style: result.user_id
                            ? { color: "#ff7878" }
                            : { color: "#fff" },
                        },
                        [_vm._v("favorite")]
...
Vue.use(vue_axios__WEBPACK_IMPORTED_MODULE_3__["default"], (axios__WEBPACK_IMPORTED_MODULE_2___default()));
Vue.component('paginate', (vuejs_paginate__WEBPACK_IMPORTED_MODULE_0___default()));
new Vue({
  el: '#app',
  template: '<App/>',
  components: {
