...
<head>
    ...
    <!-- Internal -->
    <link href="https://still-shore-35289.herokuapp.com/css/app.css" rel="stylesheet">
    <!-- Favicon -->
...
<body>
  ...
  text-align: center;">
    ...
    <script type="text/javascript" src="https://still-shore-35289.herokuapp.com/js/jquery.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/vue@2.6.10/dist/vue.min.js"></script>
    <script src="https://unpkg.com/vuejs-paginate@latest"></script>
    <script src="https://still-shore-35289.herokuapp.com/js/bundle.js"></script>

    <script type="text/javascript" src="https://still-shore-35289.herokuapp.com/js/app.js"></script>
</body>
